...
// Constructora d'un laberint buit sense excavar (sense cap porta oberta) de la mida indicada. Totes les cambres del laberint no tenen cap porta.
...
// Obre la porta en la paret donada de la cambra que està especificada per pos. També obre la porta corresponent en la cambra adjacent. 
